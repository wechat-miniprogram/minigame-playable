    ...
    execute: function () {
      ...
      _export("BoardManager", BoardManager = (_dec = ccclass("BoardManager"), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec(_class = (_class2 = class BoardManager extends Component {
        ...
        reset() {
          ...
          var pos = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          for (var _i = 0; _i < (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOARD_NUM; _i++) {
        ...
        newBoard(newType, diffLevel) {
          var oldBoard = this._boardList[(_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        getNextPos(board, count, out) {
          ...
          var o = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
...
//# sourceMappingURL=17ace60cef6651979788848b7d86d1b57a8028f9.js.map