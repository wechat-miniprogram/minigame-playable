      ...
      _export("Ball", Ball = (_dec = ccclass("Ball"), _dec2 = property(Prefab), _dec3 = property({
        ...
        update(deltaTime) {
          ...
          if ((_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            var boardBox = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
            ...
            if (this.jumpState === (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              ...
              var y = this.node.position.y + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              ...
              for (var _i = this.currBoardIdx + 1; _i >= 0; _i--) {
                ...
                if (Math.abs(pos.x - boardPos.x) <= boardList[_i].getRadius() && Math.abs(pos.y - (boardPos.y + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                  error: Error()
        ...
        activeCurrBoard() {
          ...
          var y = boardPos.y + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          if (!this.currBoard.isActive) {
            ...
            for (var l = this.currBoardIdx - (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              error: Error()
          ...
          var boardList = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          var c = boardPos.y + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        newBoard() {
          var type = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOARD_TYPE.NORMAL;

          if (this.boardGroupCount <= 0) {
            var coeff = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
              error: Error()
        ...
        showScore(score) {
          ...
          var pos = new Vec3();
          var cameraComp = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        setPosX() {
          if (this.isTouch && this.touchPosX !== this.movePosX) {
            ...
            if (this.jumpState === (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              ...
              var x = (this.movePosX - this.touchPosX) * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              ...
              x = _tempPos.x;
              var t = 1.3 * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              ...
              var _x = (this.movePosX - this.touchPosX) * (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).COEFF_POS_BALL;
          ...
          if (this.jumpState === (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            if (this.currBoard.type === (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              ...
              if (this.currJumpFrame < (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                ...
                var step = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                  error: Error()
              ...
              var _step = (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).BALL_JUMP_FRAMES - this.currJumpFrame - 1;

              _tempPos.y -= (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).BALL_JUMP_STEP[Math.floor((_step >= 0 ? _step : 0) / 2)] * this.timeScale;
            } else {
              _tempPos.y -= (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
        ...
        revive() {
          ...
          this.currJumpFrame = 0;
          this.show();
          var y = this.currBoard.node.position.y + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).CAMERA_OFFSET_Y;
          (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        playDiamondParticle(pos) {
          // @ts-ignore
          var diamondParticle = (_crd && PoolManager === void 0 ? (_reportPossibleCrUseOfPoolManager({
            error: Error()
...
//# sourceMappingURL=4052390f61b1941dc8a5ea4f3b1e845fedb5353e.js.map