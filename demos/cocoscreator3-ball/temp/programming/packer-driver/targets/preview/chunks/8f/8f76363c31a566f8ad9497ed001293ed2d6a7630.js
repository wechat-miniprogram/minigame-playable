  ...
  return {
    ...
    execute: function () {
      ...
      _export("PageResult", PageResult = (_dec = ccclass("PageResult"), _dec2 = property({
        ...
        start() {
          var reviveComp = this.result.getComponent(_crd && Revive === void 0 ? (_reportPossibleCrUseOfRevive({
            error: Error()
          }), Revive) : Revive);
...
//# sourceMappingURL=8f76363c31a566f8ad9497ed001293ed2d6a7630.js.map