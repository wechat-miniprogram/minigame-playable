  ...
  return {
    ...
    execute: function () {
      ...
      _export("Board", Board = (_dec = ccclass("Board"), _dec2 = property(Prefab), _dec3 = property({
        ...
        effectSpring() {
          const z = this.type === (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          ...
          const y = this.type === (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
          }), Constants) : Constants).BOARD_TYPE.SPRINT ? (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            error: Error()
        ...
        effectWave() {
          if (this.currWaveFrame < (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
            ...
            if (this.currWaveFrame >= (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
              ...
              this.waveInner.setScale(scale.x + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
              }), Constants) : Constants).BOARD_WAVE_INNER_STEP, scale.y, scale.z + (_crd && Constants === void 0 ? (_reportPossibleCrUseOfConstants({
                error: Error()
        ...
        setMove(coeff) {
          const t = (_crd && utils === void 0 ? (_reportPossibleCrUseOfutils({
            error: Error()
...
//# sourceMappingURL=1433e5a6ee14ee3ede263beb70e4e6eb0415614a.js.map